...
for year in ['2007', '2012']:
  for M_Set in            ['voc', 'cityscape', 'kitti', 'watercolor', 'clipart', 'sim10k', 'kitti', 'bdd100k', 'rain', 'foggy','mydata', 'mytarget']:
    for S1_Set in         ['voc', 'cityscape', 'kitti', 'watercolor', 'clipart', 'sim10k', 'kitti', 'bdd100k', 'rain', 'foggy', 'mydata', 'mytarget']:
      for S2_Set in       ['voc', 'cityscape', 'kitti', 'watercolor', 'clipart', 'sim10k', 'kitti', 'bdd100k', 'rain', 'foggy', 'mydata', 'mytarget']:
...
for year in ['2007', '2012']:
    for testdataset in ['unionvoc', 'unioncityscape', 'kitti', 'watercolor', 'clipart', 'sim10k','kitti','bdd100k','fogycityscape', 'mydata', 'mytarget']:
        for dataset in ['unionvoc', 'unioncityscape', 'kitti', 'watercolor', 'clipart', 'sim10k','kitti','bdd100k','fogycityscape', 'mydata', 'mytarget']:
